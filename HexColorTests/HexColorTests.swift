...
class HexColorTests: XCTestCase {
    ...
    func testColorMixing() {
        ...
        XCTAssertEqual(red, 0x22 / 255.0, accuracy: 0.0001, "Red component")
        XCTAssertEqual(green, 0x44 / 255.0, accuracy: 0.0001, "Green component")
        XCTAssertEqual(blue, 0x88 / 255.0, accuracy: 0.0001, "Blue component")
